...
brews=(
	...
	yt-dlp                              # Download YouTube videos in mp3, mp4 and other formats https://github.com/yt-dlp/yt-dlp
...
#! Programmatically install brew formulas
...
#! Programmatically install brew casks
...
fonts=(
	fira-code
	meslo-for-powerlevel10k
	meslo-lg-nerd-font
)

# Install fonts
#! Programmatically install brew fonts
...
macapps=(
	...
	302584613  # Amazon Kindle https://apps.apple.com/us/app/amazon-kindle/id302584613
	...
	462054704 # Word https://apps.apple.com/us/app/microsoft-word/id462054704?mt=12
...
#! Programmatically install mac apps
